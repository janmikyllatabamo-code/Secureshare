-- ============================================================================
-- Complete Fix for File Upload RLS Issues
-- This fixes both storage and database policies
-- ============================================================================

-- ============================================================================
-- PART 1: Fix Storage Policies (MOST IMPORTANT - This is likely the issue)
-- ============================================================================

-- Drop ALL existing storage policies for 'files' bucket
-- Note: If you get permission errors, you may need to delete policies via Dashboard first
...
-- If you get permission errors, skip the ALTER TABLE line below
-- ALTER TABLE storage.objects ENABLE ROW LEVEL SECURITY;

-- SIMPLIFIED POLICY: Allow authenticated users to upload to files bucket
