-- ============================================================================
-- Fix RLS Permissions - Remove auth.users references
-- This fixes the "permission denied for table users" error
-- ============================================================================

-- ============================================================================
-- PART 1: Fix Storage Policies - Remove auth.users references
-- ============================================================================
...
-- Create storage policies (files are stored as: {user_id}/filename or {user_id}/folder/filename)
...
-- ============================================================================
-- PART 2: Fix files table RLS policies - Remove auth.users references
-- ============================================================================
...
-- ============================================================================
-- PART 3: Fix shared_access table RLS policies - Remove auth.users references
-- ============================================================================

-- Drop existing policies
DROP POLICY IF EXISTS "Users can view shares with them" ON public.shared_access;

-- Recreate policy with fixed reference
...
-- ============================================================================
-- PART 4: Ensure insert_file function exists and has proper permissions
-- ============================================================================
...
-- 1. Uploading a file from the teacher dashboard
-- 2. Fetching recent files from the teacher dashboard
-- 
