...
async function createAdminUser() {
  try {
    ...
    // Check if user already exists by querying auth.users via SQL
    // We'll try to create the user and handle if it already exists
    let existingUserId = null;
    
    // First check if profile exists in secureshare_users
    ...
    if (existingProfile) {
      ...
      console.log('⚠️  Profile already exists. Updating user...');
      ...
      // Update profile in secureshare_users
